...
public class CoffeeController {
    ...
    public ResponseEntity<Map<String, Object>> update(@PathVariable("coffee-id") long coffeeId,
                                                      @RequestBody Map<String, Object> body) {
        Map<String, Object> coffee = coffees.get(coffeeId);
        coffee.put("korName", body.get("korName"));
        coffee.put("price", body.get("price"));
    ...
    public ResponseEntity<?> delete(@PathVariable("coffee-id") long coffeeId){
